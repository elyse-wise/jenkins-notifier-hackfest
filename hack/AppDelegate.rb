...
class AppDelegate
    ...
    #
    # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "hack" in the user's Library directory.
    #
    def applicationFilesDirectory
        ...
        library_url.URLByAppendingPathComponent("hack")
    end
    ...
    def managedObjectModel
        unless @managedObjectModel
          model_url = NSBundle.mainBundle.URLForResource("hack", withExtension:"momd")
    ...
    def persistentStoreCoordinator
        ...
        url = directory.URLByAppendingPathComponent("hack.storedata")
